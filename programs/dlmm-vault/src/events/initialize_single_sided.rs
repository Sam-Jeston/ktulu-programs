...
use crate::{FeeCompoundingStrategy, SingleSidedStrategy, VolatilityStrategy};

#[event]
#[derive(Debug)]
pub struct InitializeSingleSidedEvent {
    ...
    pub amount_x: u64,
    pub amount_y: u64,
    pub single_sided_strategy: SingleSidedStrategy,
}
