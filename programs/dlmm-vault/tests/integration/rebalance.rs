...
async fn test_rebalance() {
    ...
    // println!(
    //     "quote response JSON: {}",
    //     serde_json::to_string(&quote_response).unwrap()
    // );

    let quote_response_json = "{\"inputMint\":\"EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v\",\"inAmount\":\"45000\",\"outputMint\":\"Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB\",\"outAmount\":\"44959\",\"otherAmountThreshold\":\"44959\",\"swapMode\":\"ExactIn\",\"slippageBps\":0,\"platformFee\":null,\"priceImpactPct\":\"0.0002924921052258248515292374\",\"routePlan\":[{\"swapInfo\":{\"ammKey\":\"4N41hUkrayX6duXJH8oYzybVpH3mcbG8TzoM14VXmTmh\",\"label\":\"Meteora DLMM\",\"inputMint\":\"EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v\",\"outputMint\":\"Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB\",\"inAmount\":\"45000\",\"outAmount\":\"44959\",\"feeAmount\":\"18\",\"feeMint\":\"EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v\"},\"percent\":100}],\"contextSlot\":370865710,\"timeTaken\":0.000503879}";
    ...
    let ix_data = dlmm_vault::instruction::Rebalance {
